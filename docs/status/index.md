...
| `workspace` | [workspace.md](workspace.md) | Worktrees, branch/PR aliases, local artifacts, overlap, and safe next actions |
...
| worktrees, branches, PR aliases, local artifacts, duplicate work | `workspace` |
