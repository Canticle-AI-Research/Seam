...
| R2 Retrieval decisions | First-class query plans, candidate comparisons, challenges, and selection traces | Every selection identifies candidates, policy, evidence, and rejected alternatives |
