...
latest: 2026-07-11-cat13-semantic-conversation-adapter-in-progress
---
...
| --- | --- | --- | --- | --- |
| `2026-07-11-cat13-semantic-conversation-adapter-in-progress` | [2026-07-11-cat13-semantic-conversation-adapter-in-progress.md](2026-07-11-cat13-semantic-conversation-adapter-in-progress.md) | `2026-07-11-cat1-cat3-success-contract-handoff` | `HISTORY#381` | `current` |
