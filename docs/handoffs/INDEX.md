...
latest: 2026-09-13-reports-domain-publication-next
---
...
| --- | --- | --- | --- | --- |
| `2026-09-13-reports-domain-publication-next` | [2026-09-13-reports-domain-publication-next.md](2026-09-13-reports-domain-publication-next.md) | `2026-09-13-m1-report-publication-benchmark-prep` | `HISTORY#653` | `current` |
| `2026-09-13-m1-report-publication-benchmark-prep` | [2026-09-13-m1-report-publication-benchmark-prep.md](2026-09-13-m1-report-publication-benchmark-prep.md) | `2026-09-12-memory-formation-roadmap` | `HISTORY#652` | `superseded` |
...
| `2026-09-06-launch-baseline-packaging-next` | [2026-09-06-launch-baseline-packaging-next.md](2026-09-06-launch-baseline-packaging-next.md) | `2026-09-02-track-s-r1-protected-main-r2-next` | `HISTORY#634` | `superseded` |
| `2026-09-02-track-s-r1-protected-main-r2-next` | [2026-09-02-track-s-r1-protected-main-r2-next.md](2026-09-02-track-s-r1-protected-main-r2-next.md) | `2026-09-01-track-s-r1-locally-qualified-r2-next` | `HISTORY#630` | `superseded` |
...
| `2026-09-01-track-s-d3-locally-qualified-d4-next` | [2026-09-01-track-s-d3-locally-qualified-d4-next.md](2026-09-01-track-s-d3-locally-qualified-d4-next.md) | `2026-09-01-track-s-d2-locally-qualified-d3-next` | `HISTORY#623` | `superseded` |
