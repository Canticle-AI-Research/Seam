...
| Use the bounded Codex skill catalog pilot | [Codex SkillDB adapter](skills/CODEX_ADAPTER.md) | [Code layout](CODE_LAYOUT.md) and [repository policy](../REPO_LEDGER.md) |
