...
| Engineer or verify a change | [Engineering change SOP](engineering/06_ENGINEERING_CHANGE_SOP.md) | [Agent orchestration](SOP_AGENT_ORCHESTRATION.md), [verification matrix](engineering/VERIFICATION_MATRIX.md), [test and benchmark SOP](engineering/07_TEST_AND_BENCHMARK_SOP.md), and [code layout](CODE_LAYOUT.md) |
