...
| Find current state or plans | [Status streams](status/index.md) | [Project-status headline router](../PROJECT_STATUS.md), [derived roadmap state](../.seam/streams/roadmap/state.md), and [roadmap collection](roadmap/README.md) |
