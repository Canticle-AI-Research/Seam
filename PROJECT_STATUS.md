...
after its final GitHub review.** The governing reports are:
...
exact head passed every required and advisory CI lane; six later GitHub review
findings were repaired with a 175-test strict-no-skip slice and a clean
CodeRabbit rerun. A new signed head, repeat exact-head CI, and merge remain.
